...
exports.serializeDkgSign = exports.serializeDkgGetCommitments = exports.serializeDkgRound3Min = exports.serializeDkgRound2 = exports.serializeDkgRound1 = void 0;
const serializeDkgRound1 = (index, identities, minSigners) => {
...
exports.serializeDkgRound1 = serializeDkgRound1;
const serializeDkgRound2 = (index, round1PublicPackages, round1SecretPackage) => {
...
exports.serializeDkgRound2 = serializeDkgRound2;
const serializeDkgRound3Min = (index, participants, round1PublicPkgs, round2PublicPkgs, round2SecretPackage, gskBytes) => {
...
exports.serializeDkgRound3Min = serializeDkgRound3Min;
const serializeDkgGetCommitments = (tx_hash) => {
    let blob = Buffer.alloc(32);
    console.log(`dkgGetCommitment msg size: ${blob.byteLength}`);
    blob.fill(Buffer.from(tx_hash, 'hex'), 0);
    return blob;
};
exports.serializeDkgGetCommitments = serializeDkgGetCommitments;
const serializeDkgSign = (pkRandomness, frostSigningPackage, txHash) => {
...
exports.serializeDkgSign = serializeDkgSign;
